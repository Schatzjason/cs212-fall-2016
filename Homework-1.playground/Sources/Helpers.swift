...
public func generateStringOrNil() -> String? {
    ...
    let strings = ["Scarlet", "Zoom", "Agile", "Licorice", "Moonscape", "Library", "Mountain", "Submarine", "Indigo", "Camera", "Flashlight", "Birdcage", "Accelerate", "Tangerine", "Zipline", "Attic", "Algebra", "Water", "Highway", "Horizon"]
